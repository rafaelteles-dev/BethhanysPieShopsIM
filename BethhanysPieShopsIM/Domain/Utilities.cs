using BethhanysPieShopsIM.Domain.OrderManagement;
using BethhanysPieShopsIM.Domain.ProductManagement;
    ...
    internal class Utilities
    {
        ...
        private static void ShowOpenOrderOverview()
        {
            ...
            if (orders.Count > 0)
            {
                ...
                {
                    Console.WriteLine(order.ShowOrderDetails());                    Console.WriteLine();
                }
            }
            else
            {
            ...
            do
            {
                ...
                if (selectedProductId != "0")
                {
                    ...
                    if (selectedProduct != null)
                    {
                        ...
                        int amountOrdered = int.Parse(Console.ReadLine() ?? "0"); //se o primeiro for nulo, pega o segundo valor
